...
public:
    GamePeer(unsigned int width, unsigned int height, unsigned int frameRate, unsigned int updateRate, unsigned int emulatedLatency, Renderer& renderer, unsigned short port);

    GamePeer(unsigned int width, unsigned int height, unsigned int frameRate, unsigned int updateRate, unsigned int emulatedLatency, Renderer& renderer, const char* masterAddress, unsigned short port);
